    ...
    <?php 
      ...
      if(isset($trainServicesResponse) && !empty($trainServicesResponse)) {
        foreach ($trainServicesResponse as $trainService) {
          ...
          if(isset($trainService->delayReason)) {
            echo '<p class="std"></p><p class="delayReason">' . $trainService->delayReason . '</p>';
          } else if (isset($trainService->operator)) {
            echo '<p class="std"></p><p class="operator">' . $trainService->operator . '</p>';
          }
          echo '</div></div>';
          $i++;
        } 
